...
describe PagesController do
  ...
  I18n.available_locales.each do |locale|
    ...
    describe "GET 'khadvancedmemberlist'" do
      before(:each) do
      ...
      it "should have the right title" do
        title = @page_title + I18n.t(:title_khadvancedmemberlist)
        response.should have_selector('title', :content => title)
      end
    ...
    describe "GET 'khimprovedgraphics'" do
      before(:each) do
        get 'khimprovedgraphics'
      end
      ...
      it "should have the right title" do
        title = @page_title + I18n.t(:title_khimprovedgraphics)
        response.should have_selector('title', :content => title)
      end
    ...
    describe "GET 'khmedhelper'" do
      ...
      it "should have the right title" do
        title = @page_title + I18n.t(:title_khmedhelper)
        response.should have_selector('title', :content => title)
      end
