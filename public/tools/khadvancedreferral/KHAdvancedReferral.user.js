...
function getRow(id) {
  ...
  switch(id) {
	...
	case 47:
	  color = "#E9A4B1"
	  rooms = getColumn(115) + getColumn(116) + getColumn(117) + getColumn(118) + getColumn(119) + "<td colspan=\"8\"></td>"
	  break
  }
  if (numberForRoom > 0) {
